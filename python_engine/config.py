...
ARTICLE_CSV       = os.path.join(BASE_DIR, "article_dataset5.csv")
INTERACTIONS_CSV  = os.path.join(BASE_DIR, "acu_interactions_customized5.csv")
TRAIN_CSV         = os.path.join(BASE_DIR, "train_acu_customized5.csv")
TEST_CSV          = os.path.join(BASE_DIR, "test_acu_customized5.csv")
