...
ARTICLE_CSV       = os.environ.get('OVERRIDE_ARTICLE_CSV',      os.path.join(BASE_DIR, "article_dataset.csv"))
INTERACTIONS_CSV  = os.environ.get('OVERRIDE_INTERACTIONS_CSV', os.path.join(BASE_DIR, "acu_interactions.csv"))
