    ...
    <div class="login-page">
        <div class="login-card">
            <div class="login-logo">
                <img src="{{ asset('img/logo2.svg') }}" alt="ntvnews.id" style="height: 35px;">
            </div>
            ...
            @if($errors->any())
                <div
                    style="background-color: #fee2e2; color: #dc2626; padding: 12px; border-radius: 6px; margin-bottom: 20px; font-size: 14px; text-align: left; border: 1px solid #fca5a5;">
