        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            if (searchQuery) {
                ...
                if (data && data.length > 0) {
                    ...
                    list.innerHTML = `<div style="text-align:center; padding:50px; font-weight:600; color:#666;">Artikel tidak ditemukan.</div>`;
                }

                return; // Jangan load yang lain
            }

            // Fungsi helper global section
            ...
            // Delay sedikit agar script layout di app.blade.php memuat sectionsMap dulu
            setTimeout(() => {
                fetchTerkini();
                fetchPopular();
                fetchLightGCN();
